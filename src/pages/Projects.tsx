  ...
  const projects = [
    {
      ...
      description:
        "Developed a computer vision-based turret system using Python and OpenCV to detect and track moving objects in real time. The turret automatically adjusts servo angles to follow targets, demonstrating integration of image processing with electromechanical control.",
    ...
    },
    {
      ...
      description:
        "Built an RC car controlled via a custom-designed joystick-based wireless controller using Arduino and NRF24L01 modules. The project focused on real-time communication, motor control, and user-friendly remote handling for responsive navigation.",
      image: rcCarProject,
      technologies: [
        "Arduino",
        "NRF24L01",
    ...
    },
    {
      title: "Sudoku Game",
      description:
        "Interactive Sudoku puzzle game with multiple difficulty levels, hint system, and clean user interface. Built with modern web technologies for an engaging puzzle-solving experience with responsive design.",
    ...
    },
    {
      title: "Wedding Album",
      description:
        "Elegant digital wedding album platform featuring photo galleries, timeline views, and responsive design. Created to showcase wedding memories with beautiful layouts and smooth user experience.",
    ...
    },
    {
      title: "Packoria",
      description:
        "Travel packing checklist application that helps users organize and plan their trip essentials. Features intuitive item management, categorization, and a clean interface to ensure nothing is forgotten when packing for travel.",
    ...
    },
    {
      title: "WatchPopList",
      description:
        "Movie rating and tracking platform for cinema enthusiasts. Users can search, rate, and maintain lists of watched movies with detailed statistics and personalized recommendations for an enhanced movie-watching experience.",
    ...
    },
    {
      title: "SkyNow",
      description:
        "Weather forecast application providing 7-day weather predictions for any location worldwide. Features location-based weather detection, detailed daily forecasts, and an intuitive interface for quick weather information access.",
      image: skynowProject,
      technologies: [
        "JavaScript",
        "Weather API",
    ...
    },
    {
      title: "TeamLock",
      description:
        "Halısaha team management platform for creating players, building balanced teams, and simulating indoor football matches. Comprehensive tool for organizing futsal games with player statistics and team formations.",
    ...
    },
    {
      title: "Acoria",
      description:
        "Strategic card battle game with class-based characters and round-based gameplay. A divine card game of strategy featuring deck building, online play, and bot matches.",
      image: acoriaProject,
    ...
    },
    {
      title: "GeoWord Quest",
      description:
        "A word game where you collect letters by walking around in the real world and try to decipher a hidden word using those letters. Combines physical activity with puzzle solving.",
    ...
    },
    {
      title: "Izwired",
      description:
        "Comprehensive personal development and productivity platform combining task management, health tracking, and educational tools under one roof. Track habits, learn languages, and improve yourself.",
    ...
    },
    {
      title: "BlockCurse",
      description:
        "Ultimate puzzle arcade game featuring online competition, daily challenges, and leaderboards. A mystical block-blasting adventure with competitive multiplayer and ranking systems.",
    ...
    },
    {
      title: "PID World",
      description:
        "Master control engineering with interactive tools for PID tuning, stability analysis, and system simulation. Educational platform for learning control systems with calculators and visualizations.",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed px-4">
            Below are selected academic and personal projects that reflect my
            technical skills, problem-solving approach, and interest in
            engineering, automation, and software development.
          </p>
        </div>
